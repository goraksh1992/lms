...
<section class="course-content-area">
  <div class="container">
    ...
    <div class="requirements-box">
      <div class="requirements-title">Learning Mode</div>
      <div class="requirements-content">
        <ul class="requirements__list">          
            <li><?php 
            $learning_mode = $this->crud_model->get_learning_mode($course_details['learning_mode_id']); 
            echo $learning_mode['learning_type'];
            ?></li>
        </ul>
      </div>
    </div>
