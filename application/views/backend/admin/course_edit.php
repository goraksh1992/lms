<?php
    ...
    $training_options = $this->crud_model->get_training_options($course_id);
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="learning_mode_id" id="learning_mode_id" required>
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $learning_mod['learning_id'] ?>" <?php if($course_details['learning_mode_id'] == $learning_mod['learning_id']){ echo "selected"; } ?>> <?php echo $learning_mod['learning_type']; ?></option>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="training_type_id[]" id="training_type_id" required multiple>
                                                        ...
                                                        ?>
                                                            ...
                                                            <option value="<?php echo $training_ty['training_id'] ?>" <?php if(in_array($training_ty['training_id'], $arr)){ echo "selected"; }?>> <?php echo $training_ty['training_type']; ?></option> 
                                                        <?php
                                                            }
                                                         ?>
                                                        </select>
