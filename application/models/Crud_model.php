...
class Crud_model extends CI_Model
{
    ...
    public function get_learning_mode($id = ""){

        if($id != ""){

            $data = $this->db->get_where('learning_mode', array('learning_id' => $id));
            return $data->row_array();
        }else{

           $data = $this->db->get('learning_mode');
    ...
    public function get_training_type(){
        ...
        $data = $this->db->get('training_options');
        return $data->result_array();
    }
    ...
    public function add_course($param1 = "")
    {
        ...
        $data['learning_mode_id'] = $this->input->post('learning_mode_id');
        ...
        for ($i=0; $i <count($training_type_id) ; $i++) { 
            
            $this->db->insert('course_learning_options', array('course_id' => $course_id, 'training_id' => $training_type_id[$i]));
        }
    ...
    public function update_course($course_id, $type = "")
    {
        ...
        $this->db->delete('course_learning_options', array('course_id' => $course_id));
        $training_type_id = $this->input->post('training_type_id');
    ...
    public function get_training_options($course_id = ""){

        $data = $this->db->get_where('course_learning_options', array('course_id' => $course_id));
        return $data->result_array();
    }
